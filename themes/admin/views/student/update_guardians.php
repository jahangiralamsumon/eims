...
?>
	...
	<div class="topbar-left">
		<ul class="nav nav-list nav-list-topbar pull-left ">
			<li><?php  echo CHtml::link('<i class="glyphicons glyphicons-adress_book"></i> Student Details',array('/student/update','id'=>$model->student_id),array()); ?>
			</li>
			<li class="active"><?php echo CHtml::link('<i class="glyphicons glyphicons-parents"></i> Parent Details'); ?>
			</li>
