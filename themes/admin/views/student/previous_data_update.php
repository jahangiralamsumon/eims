...
$this->breadcrumbs=array(
	...
	$stu_model->name=>array('view','id'=>$stu_model->student_id),
	'Update',
);

?>

<h1>Update Student <?php echo $stu_model->student_id; ?></h1>
<header id="topbar" class="ph10">
	<div class="topbar-left">
		<ul class="nav nav-list nav-list-topbar pull-left ">
			<li><?php  echo CHtml::link('<i class="glyphicons glyphicons-adress_book"></i> Student Details',array('/student/update','id'=>$stu_model->student_id),array()); ?>
			</li>
			<li><?php echo CHtml::link('<i class="glyphicons glyphicons-parents"></i> Parent Details',array('/student/guardians','id'=>$stu_model->student_id,'gid'=>$stu_model->parent_id,'action'=>'update'),array()); ?>
			</li>
			<li class="active"><?php echo CHtml::link('<i class="glyphicons glyphicons-unshare"></i> Previous Details'); ?>
			</li>
			<li><?php echo CHtml::link('<i class="glyphicons glyphicons-book"></i> Courses',array('/student/subjectReg','id'=>$stu_model->student_id,'action'=>'update'),array()); ?>
			</li>
			<li><?php echo CHtml::link('<i class="glyphicons glyphicons-user"></i> Student Profile',array('/student/view','id'=>$stu_model->student_id,),array()); ?>
			</li>
