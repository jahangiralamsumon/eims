		...
		<div class="panel">
		   <div class="panel-heading">
			...
			<div class="panel-body">
			    ...
			    <h2 style="text-align: center;">Income Statement <small>(<?php echo date("d-M-Y",strtotime($from_date)).' to '.date("d-M-Y",strtotime($to_date))  ?> )</small></h2>
			   ...
			   <div class="row">
				...
				<h3>
					...
					if($row['balance']!=0 && $row['depth']=='0' && $row['category']=='E')
					{
						if($row['lr']=='L'){ ?>
                        <tr>
					...
					<?php 
                     ...
                     $e_total_balance=$e_total_balance+($net_profit_loss*-1);
					 ?>
					 ...
					 <tr>
					   ...
					   <td></td>
					   <td>
					   <?php echo number_format(-1*$net_profit_loss,2,'.','').' Dr'   ?>
					   </td>
					</tr>
					 <?php
                       } ?>
					 <tr>
						...
						echo $e_total_balance<0?number_format(-1*$e_total_balance,2,'.','').' Cr':number_format($e_total_balance,2,'.','').' Dr';?>
						</th>
				...
				<table class="items table table-striped table-bordered">
					...
					<?php 					
					foreach ($data as $key=> $row):										
					if($row['balance']!=0 && $row['depth']=='0' && $row['category']=='R')
					{
						if($row['lr']=='L'){ ?>
                        <tr>
						<td><?php echo $row['name']?></td>
					...
					<?php 
					 ...
					 endforeach; 
					 if($net_profit_loss>0){
                     $r_total_balance=$r_total_balance+($net_profit_loss*-1);
					 ?>
					 ...
					 <tr>
					   ...
					   <td></td>
					   <td>
					   <?php echo number_format($net_profit_loss,2,'.','').' Cr'   ?>
					   </td>
					</tr>
					 <?php
                       } ?>
					 ...
					 <tr>
						...
						echo $r_total_balance>0?number_format($r_total_balance,2,'.','').' Dr' :number_format(-1*$r_total_balance,2,'.','').' Cr';?>
						</th>
