...
class EmpDesignationController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('EmpDesignation');
	...
	{
		$model=new EmpDesignation('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['EmpDesignation']))
			$model->attributes=$_GET['EmpDesignation'];
	...
	{
		$model=EmpDesignation::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='emp-designation-form')
		{
