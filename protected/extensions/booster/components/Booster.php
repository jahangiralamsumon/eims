...
class Booster extends CApplicationComponent {
	 ...
	 * Defaults to true.
	 */
	public $coreCss = true;  //edited by sumon Defaults to true

	/**
	 * @var boolean Whether to register the Bootstrap core CSS (bootstrap.min.css).
	 * Defaults to true.
	 */
	public $bootstrapCss = false; //edited by sumon Defaults to true

	/**
	 * @var boolean whether to register the Bootstrap responsive CSS (bootstrap-responsive.min.css).
	 * Defaults to false.
	 */
	public $responsiveCss = false; //edited by sumon Defaults to true
	 ...
	 * @since 0.9.10
	 */
	public $enableJS =false;  //edited by sumon Defaults to true
