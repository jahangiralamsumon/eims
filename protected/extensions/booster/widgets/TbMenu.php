...
class TbMenu extends TbBaseMenu {
	...
	public function init() {
		...
		if (isset($this->type) && in_array($this->type, $validTypes)) {
			//$classes[] = $this->type === self::TYPE_NAVBAR ? 'navbar-nav' : 'nav-' . $this->type;    // original 
			$classes[] = $this->type === self::TYPE_NAVBAR ? 'navbar-nav' : 'tray-nav custom-nav-animation' ; //edited by sumon 01-01-15
		}
