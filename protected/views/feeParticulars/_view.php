<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('is_monthly')); ?>:</b>
	<?php echo CHtml::encode($data->is_monthly); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('is_all')); ?>:</b>
	<?php echo CHtml::encode($data->is_all); ?>
	<br />
